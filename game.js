...
function updateStats() {
    ...
    // Враги
    const aliveEnemies = enemies.filter(e => !e.destroyed).length;
    document.getElementById('statEnemies').textContent = aliveEnemies;
}
...
document.addEventListener('click', function(e) {
    ...
    if (quantityPanel && !quantityPanel.contains(e.target) && 
        !e.target.closest('.control-btn[data-action="quantity"]')) {
        closeQuantityPanel();
    }
});
